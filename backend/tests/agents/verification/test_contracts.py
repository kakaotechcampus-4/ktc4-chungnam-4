...
from tests.agents.fixtures.evidence import (EVIDENCE_ACTIVITY_PLAN, EVIDENCE_CHILD_A,
                                             EVIDENCE_CHILD_B, EVIDENCE_COMMON_ACTIVITY)

TEACHER_VOICE_MEMO_DATA = dict(EVIDENCE_CHILD_A.model_dump(), evidence_id="ev_voice",
                               source_type="teacher_voice_memo", media_id="voice_001",
...
@pytest.mark.parametrize("base", [EVIDENCE_CHILD_B.model_dump(), EVIDENCE_CHILD_A.model_dump(),
                                  EVIDENCE_COMMON_ACTIVITY.model_dump(), TEACHER_VOICE_MEMO_DATA])
...
@pytest.mark.parametrize("changes", [{"media_id": "photo_099"}, {"start_ms": 1000}, {"end_ms": 1000}])
